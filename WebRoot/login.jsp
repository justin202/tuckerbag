				...
				<div class="row">
					<div class="col-sm-5">
						<div class="basic-login">
							<form role="form" role="form" action="user!login.action">
					...
					<div class="col-sm-7 social-login">
						...
						<div class="not-member" style="text-align:center">
                        	<img src="img/loginImg.jpg" class="img-thumbnail" style="height: 18em;" />
						</div>
						<div class="clearfix"></div>
